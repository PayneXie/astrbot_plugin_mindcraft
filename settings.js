const settings = {
    ...
    "host": "shizukululu.love", // or "localhost", "your.ip.address.here"
    "port": 25585, // set to -1 to automatically scan for open ports
    "auth": "offline", // or "microsoft"

    // the mindserver manages all agents and hosts the UI
    "mindserver_port": 8076,
    "auto_open_ui": true, // opens UI in browser on startup
    
    "base_profile": "assistant", // survival, assistant, creative, or god_mode
    "profiles": [
        "./profiles/doubao.json",
        // "./andy.json",
        // "./profiles/gpt.json",
